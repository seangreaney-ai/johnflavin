      ...
      <section className="section" style={{ background: "var(--warm-white)" }}>
        <div className="container" style={{ maxWidth: "720px" }}>
          ...
          <div style={{ lineHeight: 1.8, color: "var(--text-secondary)", fontSize: "var(--text-base)" }}>
            ...
            <p style={{ marginTop: "0.75rem" }}>Contact: <a href="mailto:jfwoodinteriors@outlook.com" style={{ color: "var(--primary)" }}>jfwoodinteriors@outlook.com</a> · <a href="tel:+353870632065" style={{ color: "var(--primary)" }}>087 063 2065</a></p>
            ...
            <p>Enquiry emails are kept in our inbox for as long as they are relevant to your project. Account data is retained while your account is active. You can request deletion at any time by emailing <a href="mailto:jfwoodinteriors@outlook.com" style={{ color: "var(--primary)" }}>jfwoodinteriors@outlook.com</a>.</p>

            <h2 style={{ fontSize: "var(--text-lg)", color: "var(--dark)", marginBottom: "0.75rem", marginTop: "2.5rem" }}>Your rights</h2>
            <p>Under GDPR you have the right to access, correct, or delete the personal data we hold about you. To exercise any of these rights, contact us at <a href="mailto:jfwoodinteriors@outlook.com" style={{ color: "var(--primary)" }}>jfwoodinteriors@outlook.com</a>. We will respond within 30 days.</p>
